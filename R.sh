...
sudo su - -c "R -e \"install.packages('devtools', repos='http://cran.rstudio.com/',dependencies=T)\""
sudo su - -c "R -e \"install.packages('Rcpp', repos='http://cran.rstudio.com/',dependencies=T)\""
sudo su - -c "R -e \"install.packages('RcppEigen', repos='http://cran.rstudio.com/',dependencies=T)\""
sudo su - -c "R -e \"install.packages('ggplot2', repos='http://cran.rstudio.com/',dependencies=T)\""
sudo su - -c "R -e \"install.packages('knitr', repos='http://cran.rstudio.com/',dependencies=T)\""
